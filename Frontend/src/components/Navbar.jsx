...
//   // CRITICAL: Get fresh auth state from localStorage every render
...
//   const isLoggedIn = authState.accessToken && authState.userType;
...
//                   {notifications > 0 && (
//                     <>
//                       <span className="absolute -top-1 -right-1 bg-gradient-to-r from-red-500 to-pink-600 text-white text-xs font-bold rounded-full h-6 w-6 flex items-center justify-center shadow-md z-10">
//                         {notifications}
//                       </span>
//                       <span className="absolute -top-1 -right-1 bg-red-500 rounded-full h-6 w-6 animate-ping opacity-75"></span>
//                     </>
...
//               <button
//                 onClick={handleLogout}
//                 className="hidden md:flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-red-500 to-rose-600 text-white hover:from-red-600 hover:to-rose-700 rounded-xl font-bold transition-all duration-300 shadow-md shadow-red-500/20 hover:shadow-lg hover:scale-105"
//               >
//                 <LogOut size={18} />
//                 <span>Logout</span>
//               </button>
...
//                     setMobileMenuOpen(false);
//                   }}
//                   className="flex items-center gap-3 px-5 py-4 rounded-xl font-semibold transition-all text-gray-700 hover:bg-gray-50 w-full text-left"
//                 >
//                   <div className="relative">
//                     <Bell size={22} />
//                     {notifications > 0 && (
