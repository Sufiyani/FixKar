...
//   XCircle, Power, Wifi, WifiOff, User, Mail, Home, Sparkles, BadgeCheck,
//   Zap, TrendingDown, ArrowUpRight, Target, ChevronRight, MessageSquare
// } from "lucide-react";
...
//                   <div key={srv._id} className="bg-white rounded-3xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all group animate-fadeIn" style={{ animationDelay: `${index * 50}ms` }}>
...
//                   <div key={booking._id} className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100 hover:shadow-xl transition-all animate-fadeIn" style={{ animationDelay: `${index * 50}ms` }}>
