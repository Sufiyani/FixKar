...
const Login = () => {
  ...
  useEffect(() => {
    ...
    // CRITICAL: Check if wrong user type is logged in
    const currentUserType = localStorage.getItem('userType');
    const hasToken = localStorage.getItem('accessToken');

    if (hasToken && currentUserType) {
      // If already logged in as the same type, redirect to dashboard
      if (currentUserType === type) {
        ...
        // Wrong user type is logged in, clear everything
...
//     // IMMEDIATE CHECK: Clear wrong user type
//     const currentUserType = localStorage.getItem('userType');
//     const hasToken = localStorage.getItem('accessToken');

//     console.log('🔍 Login Page Check:', { currentUserType, hasToken, pageType: type });

//     if (hasToken && currentUserType) {
//       if (currentUserType === type) {
//         // Same type - redirect to dashboard
//         console.log('✅ Same user type, redirecting to dashboard');
//         navigate(type === 'admin' ? '/admin-dashboard' : '/vendor-dashboard');
//       } else {
//         // WRONG TYPE - CLEAR IMMEDIATELY!
//         console.log('❌ Wrong user type detected! Clearing...');
//         console.log(`   Current: ${currentUserType}, Page: ${type}`);
...
//           localStorage.setItem('vendorId', data._id || data.vendor?._id);
//           localStorage.setItem('vendorName', data.name || data.vendor?.name);
//           localStorage.setItem('vendorEmail', data.email || data.vendor?.email);
