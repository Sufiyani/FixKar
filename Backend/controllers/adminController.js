...
// ========================================
// COMPLETE adminController.js FILE
// ========================================
...
// export const cleanupOrphanedServices = async (req, res) => {
//   try {
//     // Find all services
...
//     // Check each service if its vendor exists
//     for (const service of services) {
//       const vendorExists = await Vendor.findById(service.vendorId);
      
//       if (!vendorExists) {
//         // Delete service if vendor doesn't exist
...
//     res.json({ 
//       message: `Cleanup completed. ${deletedCount} orphaned services removed.`,
//       deletedCount,
//       deletedServices
//     });
//   } catch (error) {
...
// ========================================
// FINAL adminController.js - KEEP THIS VERSION
// ========================================
